firebase.auth().onAuthStateChanged(function(user) {
  if (user) {
	...
	if(user != null){
     ...
     firebase.database().ref('/cUsers/').once('value').then(function(snapshot) {
  // ...
          var child1= snapshot.hasChild(user.uid);
		  return child1;
		  window.alert(child1);
  ...
  document.getElementById("user_para").innerHTML = "Welcome User : "+ username +"<br> Email: " + email_id +"<br>Address: " + address1;
});
