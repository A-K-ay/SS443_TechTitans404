...
<head>
    ...
    <!-- Custom CSS -->
    <link href="css/theme-casual.css" rel="stylesheet">
...
<body>
    ...
    <div class="brand">EV EUTOPIA</div>
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-lg-12 text-center">
                    <div class="col-lg-6"><img class="img-responsive img-border img-full" src="img/b5.png" alt=""></div>
                     <div class="col-lg-6"><h2>ELECTRIC VEHICLE 1
                        <br>
                ...
                <div class="col-lg-12 text-center">
                    <div class="col-lg-6"><img class="img-responsive img-border img-full" src="img/b4.png" alt=""></div>
                    <div class="col-lg-6"><h2>ELECTRIC VEHICLE 2
                        <br>
                        <small>October 13, 2013</small>
                    </h2>
                    <p>Lid est laborum dolo rumes fugats untras. Etharums ser quidem rerum facilis dolores nemis omnis fugats vitaes nemo minima rerums unsers sadips amets. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                ...
                <div class="col-lg-12 text-center">
                    <div class="col-lg-6"><img class="img-responsive img-border img-full" src="img/aaa.jpg" alt=""></div>
                    <div class="col-lg-6"><h2>ELECTRIC VEHICLE 3
                        <br>
                        <small>October 13, 2013</small>
                    </h2>
                    <p>Lid est laborum dolo rumes fugats untras. Etharums ser quidem rerum facilis dolores nemis omnis fugats vitaes nemo minima rerums unsers sadips amets. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                ...
                <div class="col-lg-12 text-center">
                    <ul class="pager">
                        ...
                        <li class="next"><a href="blog2.php">Newer &rarr;</a>
                        </li>
                    </ul>
                </div>
            </div>
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
		  <div class="modal-header">
		    ...
		    <h4 class="modal-title">electrical vehicle 1</h4>
		  </div>
	...
	<div id="mymodal2" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	    <div class="modal-content">
		  <div class="modal-header">
		    <button type="button" class="close" data-dismiss="modal">&times;</button> 
		    <h4 class="modal-title">electrical vehicle 3 </h4>
		  </div>
		  <div class="modal-body">
		    <p>Sample content</p>
		  </div>
